...
const ChatArea = ({ messages, isLoading, messagesEndRef, user }) => {
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-8 scroll-smooth pt-12">
      {messages.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-full animate-in fade-in zoom-in duration-500">
          ...
          <div className="mb-8 relative">
            <div className="h-24 w-24 rounded-full bg-gradient-to-br from-[#6c5dd3]/20 via-[#a5a6f6]/20 to-gray-50 blur-xl opacity-70 animate-pulse" />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="h-16 w-16 rounded-full bg-gradient-to-tr from-[#6c5dd3] to-[#5b4eb8] shadow-lg shadow-[#6c5dd3]/30 flex items-center justify-center text-white">
